...
import Button from "../../Button"; // plasmic-import: 3vuC_zhePC1D/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: b4M7MIVfMAjZ/css

import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: PFAeyq76T247/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: llHIdVMk_4eB/icon
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__xDuMo)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___7N4X)}
              >
                <div
                  className={classNames(
                    projectcss.all,
