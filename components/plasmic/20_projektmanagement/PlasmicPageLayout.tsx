...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: Ib_kB-8U0z5E/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ReiOSD7tNZx1/icon
import Logo1024SvgIcon from "./icons/PlasmicIcon__Logo1024Svg"; // plasmic-import: npGm0SqsKerP/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Logo1024SvgIcon
          className={classNames(projectcss.all, sty.svg__deKrn)}
          role={"img"}
        />
      }
      menu={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__idu7V)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___4Z9L0)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__aUuC6)}>
              {renderPlasmicSlot({
